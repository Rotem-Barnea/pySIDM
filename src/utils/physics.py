...
def local_density(
    ...
    volume_kind: Literal['density', 'shell'] = 'density',
    mass_kind: Literal['sum', 'single'] = 'sum',
) -> types.QuantityLike:
...
def acceleration(r: types.QuantityLike, M: types.QuantityLike, L: types.QuantityLike) -> types.QuantityLike:
