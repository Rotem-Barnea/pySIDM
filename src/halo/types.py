...
class OptimizeDtParams(TypedDict, total=False):
    ...
    Attributes:
        ...
        reoptimize_rate: How often should the iteration loop be paused to reoptimize the timestep. Split the evolution loop into chunks of this duration and reoptimize the time-step (`dt`) at the start of each chunk.
    """
