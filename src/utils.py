...
def setup_plot(fig:Figure|None=None,ax:Axes|None=None,grid:bool=True,minorticks:bool=False,title:str|None=None,xlabel:str|None=None,
               ylabel:str|None=None) -> tuple[Figure,Axes]:
