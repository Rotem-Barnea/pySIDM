...
class Density:
    def __init__(
        self,
        Rmin: units.Quantity['length'] = 1e-4 * units.kpc,
        Rmax: units.Quantity['length'] | None = None,
        Rs: units.Quantity['length'] = 1 * units.kpc,
        Rvir: units.Quantity['length'] = 1 * units.kpc,
        Mtot: units.Quantity['mass'] = 1 * units.Msun,
        unit_mass: units.Quantity['mass'] = 1 * units.Msun,
  ...
  - particle mass = {self.unit_mass:.3e}"""
    ...
    def Tdyn(self) -> units.Unit:
        if 'Tdyn' not in self.memoization:
            self.memoization['Tdyn'] = units.def_unit(
    ...
    def plot_rho(
        self,
        r_start: units.Quantity['length'] | None = None,
        r_end: units.Quantity['length'] | None = 1e4 * units.kpc,
    ...
    def plot_radius_distribution(
        self,
        r_start: units.Quantity['length'] | None = None,
        r_end: units.Quantity['length'] | None = None,
        cumulative: bool = False,
        plot_units: UnitLike = 'kpc',
        fig: Figure | None = None,
        ax: Axes | None = None,
    ) -> tuple[Figure, Axes]:
